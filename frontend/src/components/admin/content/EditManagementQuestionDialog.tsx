...
interface EditManagementQuestionDialogProps {
  ...
  question: ManagementQuestion | null;
}
...
export const EditManagementQuestionDialog = ({ open, onOpenChange, question }: EditManagementQuestionDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white border-none text-black max-w-[500px]">
        <DialogHeader className="border-b pb-4">
          <DialogTitle className="text-xl font-bold">Edit Management Question</DialogTitle>
        </DialogHeader>
        <div className="space-y-6 py-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="How many freelancers work for you?"
