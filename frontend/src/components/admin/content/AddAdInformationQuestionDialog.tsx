...
interface AddAdInformationQuestionDialogProps {
  open: boolean;
...
export const AddAdInformationQuestionDialog = ({ open, onOpenChange }: AddAdInformationQuestionDialogProps) => {
  ...
  const handleSubmit = (e?: React.FormEvent) => {
    ...
    console.log('Submitting ad information question:', {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white border-none text-black max-w-[500px]">
        <DialogHeader className="border-b pb-4">
          <DialogTitle className="text-xl font-bold">Add Ad Information Question</DialogTitle>
        </DialogHeader>
