...
export const AddManagementQuestionDialog = ({ open, onOpenChange }: AddManagementQuestionDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white border-none text-black max-w-[500px]">
        <DialogHeader className="border-b pb-4">
          <DialogTitle className="text-xl font-bold">Add Management Question</DialogTitle>
        </DialogHeader>
